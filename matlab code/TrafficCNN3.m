...
bot   = 'http://192.168.43.68';
boton = 'http://192.168.43.68/ON';
botoff ='http://192.168.43.68/OFF';

% Display one training image and the ground truth bounding boxes
for k = 1:2
    I = imread(stopSigns.imageFilename{k});
    I = insertObjectAnnotation(I,'Rectangle',stopSigns.stopSign{k},'stop sign','LineWidth',8);
